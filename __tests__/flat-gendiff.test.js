...
const correctAnswer1 = `${fixturesPath}answ-flat-01-tree`;
const correctAnswer2 = `${fixturesPath}answ-flat-02-tree`;
const correctAnswer3 = `${fixturesPath}answ-flat-03-tree`;
